...
@Component({
	selector: 'app-users',
	templateUrl: './users_dealer.component.html',
	styleUrls: ['./users_dealer.component.scss']
})
export class UsersDealerComponent implements OnInit {
	...
	delete(rec: any): void {
		this.isLoading = true;
		this.apiService.apiRequestDeleteWithToken('api/deleteDealer/'+rec.id).subscribe((resp) => {
